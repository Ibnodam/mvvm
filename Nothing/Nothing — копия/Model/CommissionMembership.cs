...
namespace Nothing.Model; public partial class CommissionMembership : BaseClass
{
    [Key]
    public int ComisMemId { get; set; }

    private int commissionId;
    public int CommissionId
    {
        get => commissionId;
        set { commissionId = value; OnPropertyChanged(nameof(CommissionId)); }
    }
